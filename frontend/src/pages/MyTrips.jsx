...
const MyTrips = () => {
  ...
  const fetchTrips = async () => {
    try {
      ...
      // If no trips available, show demo data for now
      setTimeout(() => {
        const demoTrips = [
          {
            bookingId: 'TRB123456',
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-purple-600">
                ₹{trips.reduce((sum, trip) => sum + (trip.paymentDetails?.totalAmount || 0), 0).toLocaleString()}
              </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold">₹{(trip.paymentDetails?.totalAmount || 0).toLocaleString()}</span>
                            </div>
                            <div className="flex justify-between">
                              <span>Status:</span>
                              <Badge variant="outline" className="text-green-600 border-green-600">
                                {trip.paymentDetails?.paymentStatus || 'N/A'}
                              </Badge>
                            </div>
                            <div className="flex justify-between">
                              <span>Transaction ID:</span>
                              <span className="font-mono text-xs">{trip.paymentDetails?.transactionId || 'N/A'}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mt-6 pt-6 border-t">
                          ...
                          <div className="bg-gray-50 p-4 rounded-lg">
                            <div className="text-sm">
                              ...
                              {trip.itinerary[0].activities.slice(0, 2).map((activity, index) => (
