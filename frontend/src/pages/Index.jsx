        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img 
                src="https://wallpaperaccess.com/full/3479478.jpg" 
                alt="Tirupati Temple"
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img 
                src="https://curlytales.com/wp-content/uploads/2022/12/Untitled-design-2022-12-06T124220.312.jpg" 
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img 
                src="http://www.go2india.in/upimg/1644.jpg" 
                alt="Visakhapatnam Beach"
                className="h-48 w-full object-cover"
              />
              <div className="p-4">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img 
                src="https://assets.thehansindia.com/h-upload/2022/11/25/1322217-srisailam-temple.jpg" 
